<nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
    <a class="navbar-brand" href="#">Spartakos</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
            <a class="nav-link" href="/about_us">Klubovi</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/about_us">Treneri</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/about_us">Kontakt</a>
        </li>
